          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-sm">+230 58566001</span>
              </motion.a>
              <motion.a
                href="https://phytomax.shop"
                className="flex items-center gap-3 text-gray-400 hover:text-gold transition-colors group"
                whileHover={{ x: 5 }}
              >
                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-gold/20 transition-colors">
                ...
                <span className="text-sm">phytomax.shop</span>
              </motion.a>
            </div>
          </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              ...
              <span className="text-gold">Phytomax Mauritius</span>. All rights
              reserved.
            </p>
